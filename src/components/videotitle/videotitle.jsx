     ...
     return(
        <>
         <div className='title'>
             ...
             <h4 className='movie-specs'> 2012 <span className="dot"></span>2h24m <span className="dot"></span> 4 languages <span className="dot"></span> U/A 16+ </h4>          
         </div>
    ...
    <>
      <div className="title">
        ...
        <h4 className="movie-specs">
          2012 <span className="dot"></span> 2h24m <span classname="dot"></span>{" "}
          4 languages <span classname="dot"></span> U/A 16+
        </h4>
      </div>
      <div className="description">
        <div className="description-text">
...
>>>>>>> e1260a1d124828b4e8a2efefb535f77474bb43ad
